...
import {
  loadOverrides as loadOverridesFrom,
  applyOverrides,
...
// Overrides live in scripts/lib/overrides.js, shared with build-pptx-hymnal.js.
const loadOverrides = (slug) => loadOverridesFrom(outputDir, slug);
